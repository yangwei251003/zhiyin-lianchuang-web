...
export const ASSET_MANIFEST = [
  ...
  { path: '/images/external/press-tools.jpg', purpose: '产教实践视觉背景', source: 'Pexels', sourceUrl: 'https://www.pexels.com/photo/person-working-on-industrial-machine-6620977/', license: 'Pexels License（免费下载和使用）', downloadedAt: '2026-07-12', alt: '工作人员调整印刷设备' },
